    ...
    15366: (e, t, r) => {
          ...
          (this.glareAngle = 0),
            ...
            (this.updateAngle = (e, t) => {
              let { xPercentage: r, yPercentage: n } = e,
                i = 180 / Math.PI,
                o = r ? Math.atan2(n, -r) * i : 0;
              this.glareAngle = o - 180 * !!t;
            }),
            (this.updateOpacity = (e, t, r, n) => {
              let { xPercentage: i, yPercentage: o } = e,
        ...
        constructor() {
          (this.glareAngle = 0),
            ...
            (this.updateTiltLimits = (e) => {
              let { tiltAxis: t } = e;
              (this.tiltAngleX = a(this.tiltAngleX, -90, 90)),
                (this.tiltAngleY = a(this.tiltAngleY, -90, 90)),
                t &&
      ...
      class u extends i.PureComponent {
        constructor() {
          super(...arguments),
            ...
            (this.onLeave = (e) => {
              ...
              if (
                (this.setTransitions(), t && t({ event: e }), this.props.reset)
              ) {
            ...
            (this.processInput = (e) => {
              ...
              switch (e.type) {
                ...
                case "autoreset": {
                  ...
                  (this.wrapperEl.clientPosition.xPercentage = a(
                    (e / r) * 100,
                    -100,
                    100
                  )),
                    (this.wrapperEl.clientPosition.yPercentage = a(
                      (t / n) * 100,
                      -100,
                      100
                    )),
            ...
            (this.updateClientInput = () => {
              ...
              (this.wrapperEl.clientPosition.xPercentage = a(e, -100, 100)),
                (this.wrapperEl.clientPosition.yPercentage = a(t, -100, 100));
            }),
            (this.updateFlip = () => {
        ...
        initGlare() {
          ...
          e &&
            ((this.glare = new s(this.wrapperEl.size, t)),
        ...
        setTransitions() {
          ...
          o(this.wrapperEl.node, "all", e, t),
            this.glare && o(this.glare.glareEl, "opacity", e, t);
        }
        render() {
      ...
      function o(e, t) {
        for (let [o, a] of Object.entries(t)) {
          ...
          "SCRIPT" === e.tagName && i(s)
            ...
            (!1 === a ||
              ("SCRIPT" === e.tagName && i(s) && (!a || "false" === a))) &&
                  ...
                  function t(e, r) {
                    ...
                    if (
                      ...
                      A(this, "addEventToStateProperty", function (e, t) {
                        ...
                        return (
                          (b.state[n] = r
                            ? [i].concat(_(b.state[n]))
                            : [].concat(_(b.state[n]), [i])),
                          b
                        );
                      }),
                            ...
                            switch (
                              ...
                              case s:
                                ...
                                b.options.onCreateTextNode &&
                                  ...
                                  (P = b.options.onCreateTextNode(A, j)),
                                  P &&
                                    (O
                                      ? O.appendChild(P)
                              ...
                              case f:
                                var T = o.eventArgs,
                                  M = T.cb,
                                  C = T.thisArg;
                                M.call(C, { elements: b.state.elements });
                                break;
                              case d:
                                var L = o.eventArgs,
                                  k = L.node,
                                ...
                                I
                                  ? I.appendChild(k)
                                  : b.state.elements.wrapper.appendChild(k),
                                  (b.state.visibleNodes = [].concat(
                                    _(b.state.visibleNodes),
                                    [
                                      {
              ...
              2492: (e, t, r) => {
                ...
                e.exports = function (e, t, r, v, g, y) {
                  ...
                  if (A && !_)
                    return (
                      y || (y = new n()),
                      m || c(e) ? i(e, t, r, v, g, y) : o(e, t, w, r, v, g, y)
                    );
                  if (!(1 & r)) {
                ...
                e.exports = function (e, t, r, a, s, l) {
                  ...
                  for (l.set(e, t), l.set(t, e); ++h < c; ) {
                    var y = e[h],
                      m = t[h];
                    if (a)
                      var b = u ? a(m, y, h, t, e, l) : a(y, m, h, e, t, l);
                    if (void 0 !== b) {
                      if (b) continue;
                      v = !1;
                      break;
                ...
                e.exports = function (e, t, r, o, a, s) {
                  ...
                  for (var g = l; ++p < c; ) {
                    var y = e[(f = u[p])],
                      m = t[f];
                    if (o)
                      var b = l ? o(m, y, f, t, e, s) : o(y, m, f, e, t, s);
                ...
                var r,
                  ...
                  o =
                    ...
                    function () {
                      ...
                      return (
                        (e = i
                          ? Reflect.construct(t, arguments, c(this).constructor)
      ...
      function y(e) {
        ...
        if (
          ...
          ("beforeInteractive" === u || "worker" === u) &&
            (g
              ? ((y[u] = (y[u] || []).concat([
                  { id: t, src: r, onLoad: n, onReady: i, onError: p, ...v },
                ])),
                g(y))
              : m && m()
              ? f.add(t || r)
            ...
            return r
              ? (a.default.preload(
                  ...
                  v.integrity
                    ...
                    : { as: "script", nonce: w, crossOrigin: v.crossOrigin }
                ),
                (0, o.jsx)("script", {
                  nonce: w,
                  dangerouslySetInnerHTML: {
