        ...
        !(function () {
          ...
          (function () {
            ...
            for (let t = 0; t < T.length; t++)
              (T[t].y =
                R[F.length + t] + 45 * Math.sin((t * B * Math.PI) / 180)),
                (T[t].x =
            ...
            for (let t = 0; t < X.length; t++)
              (X[t].y =
                R[F.length + E + D.length + t] + 0 + t * S * Math.sin(s)),
                (X[t].x =
                  Y[F.length + E + D.length + t] + 0 + t * S * Math.cos(s)),
                (n.fillStyle = X[t].color),
                n.fillText(X[t].value, X[t].x, X[t].y);
            for (let t = 0; t < I.length; t++)
              (I[t].y =
                R[F.length + E + D.length + X.length + t] +
                0 +
                t * S * Math.sin(i)),
                (I[t].x =
